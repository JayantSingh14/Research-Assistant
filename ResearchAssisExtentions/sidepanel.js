...
function downloadAsPDF() {
    ...
    // // auto wrap long text
    // const lines = doc.splitTextToSize(notesContent, 180);
    // doc.text(lines, 10, 10);
    // doc.save("ResearchNotes.pdf");
    const { jsPDF } = window.jspdf;
    const doc = new jsPDF();
    ...
    let filename = prompt("Enter a name for your PDF file:", "ResearchNotes");
    if (!filename || filename.trim() === "") {
        filename = "ResearchNotes";
    }
